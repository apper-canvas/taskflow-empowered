    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6 p-6 bg-white dark:bg-surface-800 rounded-xl shadow-card">
          ...
          <p className="text-center text-sm text-surface-600 dark:text-surface-300">Already have an account? <Link to="/login" className="text-primary hover:underline">Sign In</Link></p>
        </div>
      </div>
    </motion.div>
  );
